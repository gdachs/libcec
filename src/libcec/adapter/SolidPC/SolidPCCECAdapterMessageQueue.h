...
{
  class CSolidPCCECAdapterCommunication;
  ...
  {
    friend class CSolidPCCECAdapterCommunication;
  ...
  public:
     ...
     */
    CCECAdapterMessageQueue(CSolidPCCECAdapterCommunication *com);
  ...
  private:
    CSolidPCCECAdapterCommunication *                            m_com;                    /**< the communication handler */
    P8PLATFORM::CMutex                                       m_mutex;                  /**< mutex for changes to this class */
