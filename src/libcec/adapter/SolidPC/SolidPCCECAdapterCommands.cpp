...
{
CSolidPCCECAdapterCommands::CSolidPCCECAdapterCommands(CSolidPCCECAdapterCommunication *comm) :
    m_comm(comm),
...
cec_datapacket CSolidPCCECAdapterCommands::RequestSetting(cec_adapter_messagecode msgCode)
{
...
uint16_t CSolidPCCECAdapterCommands::RequestFirmwareVersion(void)
{
...
bool CSolidPCCECAdapterCommands::RequestSettingAutoEnabled(void)
{
#ifdef CEC_DEBUGGING
...
bool CSolidPCCECAdapterCommands::RequestSettingCECVersion(void)
{
#ifdef CEC_DEBUGGING
...
bool CSolidPCCECAdapterCommands::RequestSettingDefaultLogicalAddress(void)
{
#ifdef CEC_DEBUGGING
...
bool CSolidPCCECAdapterCommands::RequestSettingDeviceType(void)
{
#ifdef CEC_DEBUGGING
...
bool CSolidPCCECAdapterCommands::RequestSettingLogicalAddressMask(void)
{
#ifdef CEC_DEBUGGING
...
bool CSolidPCCECAdapterCommands::RequestSettingOSDName(void)
{
#ifdef CEC_DEBUGGING
...
bool CSolidPCCECAdapterCommands::RequestSettingPhysicalAddress(void)
{
#ifdef CEC_DEBUGGING
...
bool CSolidPCCECAdapterCommands::SetSettingAutoEnabled(bool enabled)
{
  bool bReturn(false);
...
bool CSolidPCCECAdapterCommands::SetSettingDeviceType(cec_device_type type)
{
  bool bReturn(false);
...
bool CSolidPCCECAdapterCommands::SetSettingDefaultLogicalAddress(cec_logical_address address)
{
  bool bReturn(false);
...
bool CSolidPCCECAdapterCommands::SetSettingLogicalAddressMask(uint16_t iMask)
{
  bool bReturn(false);
...
bool CSolidPCCECAdapterCommands::SetSettingPhysicalAddress(uint16_t iPhysicalAddress)
{
  bool bReturn(false);
...
bool CSolidPCCECAdapterCommands::SetSettingCECVersion(cec_version version)
{
  bool bReturn(false);
...
bool CSolidPCCECAdapterCommands::SetSettingOSDName(const char *strOSDName)
{
  bool bReturn(false);
...
bool CSolidPCCECAdapterCommands::WriteEEPROM(void)
{
  {
    CLockObject lock(m_mutex);
    if (!m_bNeedsWrite)
...
bool CSolidPCCECAdapterCommands::PersistConfiguration(const libcec_configuration &configuration)
{
  bool bReturn(false);
  if (m_persistedConfiguration.iFirmwareVersion < 2)
    return bReturn;
...
bool CSolidPCCECAdapterCommands::RequestSettings(void)
{
  if (m_persistedConfiguration.iFirmwareVersion < 2)
  {
...
bool CSolidPCCECAdapterCommands::GetConfiguration(libcec_configuration &configuration)
{
...
bool CSolidPCCECAdapterCommands::PingAdapter(void)
{
#ifdef CEC_DEBUGGING
...
bool CSolidPCCECAdapterCommands::SetAckMask(uint16_t iMask)
{
...
void CSolidPCCECAdapterCommands::SetActiveSource(bool bSetTo, bool bClientUnregistered)
{
...
bool CSolidPCCECAdapterCommands::StartBootloader(void)
{
...
bool CSolidPCCECAdapterCommands::SetLineTimeout(uint8_t iTimeout)
{
...
bool CSolidPCCECAdapterCommands::SetControlledMode(bool controlled)
{
  {
    CLockObject lock(m_mutex);
