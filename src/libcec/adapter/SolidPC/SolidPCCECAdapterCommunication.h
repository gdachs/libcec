...
{
  class CSolidPCCECAdapterCommands;
  class CCECAdapterMessageQueue;
  class CCECAdapterMessage;

  class CSolidPCCECAdapterCommunication : public CEC::IAdapterCommunication, public P8PLATFORM::CThread
  {
    friend class CSolidPCCECAdapterCommands;
  ...
  public:
     ...
     */
    CSolidPCCECAdapterCommunication(IAdapterCommunicationCallback *callback, const char *strPort, uint16_t iBaudRate = CEC_SERIAL_DEFAULT_BAUDRATE);
    virtual ~CSolidPCCECAdapterCommunication(void);
  ...
  private:
    ...
    CSolidPCCECAdapterCommands *                     m_commands;             /**< commands that can be sent to the adapter */
