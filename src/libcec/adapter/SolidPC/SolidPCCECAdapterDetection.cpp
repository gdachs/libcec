...
#define CEC_VID  0x0483
#define CEC_PID  0x5740

using namespace CEC;

#if defined(HAVE_LIBUDEV)
bool CSolidPCCECAdapterDetection::TranslateComPort(std::string& strString)
{
...
bool CSolidPCCECAdapterDetection::FindComPort(std::string& strLocation)
{
...
bool CSolidPCCECAdapterDetection::CanAutodetect(void)
{
...
uint8_t CSolidPCCECAdapterDetection::FindAdaptersWindows(cec_adapter_descriptor* deviceList, uint8_t iBufSize, const char* strDevicePath /* = NULL */)
{
  uint8_t iFound(0);
...
uint8_t CSolidPCCECAdapterDetection::FindAdaptersApple(cec_adapter_descriptor *deviceList, uint8_t iBufSize, const char *strDevicePath /* = NULL */)
{
  uint8_t iFound(0);
...
uint8_t CSolidPCCECAdapterDetection::FindAdaptersUdev(cec_adapter_descriptor *deviceList, uint8_t iBufSize, const char *strDevicePath /* = NULL */)
{
  uint8_t iFound(0);
...
uint8_t CSolidPCCECAdapterDetection::FindAdaptersFreeBSD(cec_adapter_descriptor *deviceList, uint8_t iBufSize, const char *strDevicePath /* = NULL */)
{
  uint8_t iFound(0);
...
uint8_t CSolidPCCECAdapterDetection::FindAdapters(cec_adapter_descriptor *deviceList, uint8_t iBufSize, const char *strDevicePath /* = NULL */)
{
  uint8_t iFound(0);
